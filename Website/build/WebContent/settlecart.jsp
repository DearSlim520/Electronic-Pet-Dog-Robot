        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            <div class="main-content">
              ...
              <div class="container">
               <form name="pay"  method="post" action="./pay" onsubmit="return check()">
                   <%String id = (String)session.getAttribute("id"); %>
                      
                   
                      Wechat<input type="radio" name="payment" value="Wechat">
                      Credit card<input type="radio" name="payment" value="Credit card">
                      Alipay<input type="radio" name="payment" value="Alipay">
