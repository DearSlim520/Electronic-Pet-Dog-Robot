...
if(nam==null){session.setAttribute("username"," ");}%>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="caption">
              ...
              <p>The Pixie Company is a new company that integrates all kinds of high-tech products. There are all kinds of new products and smart devices here. More exciting things are waiting for you to discover!</p>
              <div class="main-button">
                <a href="moreinfo.jsp">More Information</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            ...
            if(list!=null&&list.size()>0){
             ...
             %> 
                ...
                <a href="products.jsp">
                 <img src="proimages/<%=item.getPicture()%>"width="120" height="180">
                  <h4><%=item.getName() %></h4>
                  </a>
                </div>
          <%
